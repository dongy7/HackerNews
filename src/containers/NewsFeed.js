...
class NewsFeedWrapper extends React.Component {
  ...
  getPageCount() {
    const itemCount =
      this.getType() === 'topstories'
        ? this.props.topPageCount
        : this.props.newPageCount
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      params.type !== prevProps.params.type ||
...
const NewsFeed = withRouter(
  connect(mapStateToProps, mapDispatchToProps)(NewsFeedWrapper)
)
